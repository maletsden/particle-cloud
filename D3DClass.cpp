...
ID3D11Device* D3DClass::GetDevice() noexcept
{
    return m_device;
}

ID3D11DeviceContext* D3DClass::GetDeviceContext() noexcept
{
    return m_deviceContext;
}

const Matrix& D3DClass::GetProjectionMatrix() const noexcept
{
    return m_projectionMatrix;
}

const Matrix& D3DClass::GetWorldMatrix() const noexcept
{
    return m_worldMatrix;
}

const Matrix& D3DClass::GetOrthoMatrix() const noexcept
{
